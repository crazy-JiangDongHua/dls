...
def xavier_uniform(fan_in, fan_out, shape=None, gain=1.0, **kwargs):
    ...
    return rand(*(shape if shape else (fan_in, fan_out)), low=-a, high=a, **kwargs)
    ### END YOUR SOLUTION
...
def xavier_normal(fan_in, fan_out, shape=None, gain=1.0, **kwargs):
    ...
    return randn(*(shape if shape else (fan_in, fan_out)), mean=0, std=std, **kwargs)
    ### END YOUR SOLUTION
...
def kaiming_uniform(fan_in, fan_out, shape=None, nonlinearity="relu", **kwargs):
    ...
    return rand(*(shape if shape else (fan_in, fan_out)), low=-bound, high=bound, **kwargs)
    ### END YOUR SOLUTION
